...
## Article Context
- articleTitle: 미수금 관리표를 만드는 방법
- categoryStyle: 영업 운영: 매출, 미수금, 목표, 리포트 흐름이 정돈되어 보이는 실무형 영업 운영 보드
- visualDifferentiationHint: 리포트 흐름를 중심 모티프로 사용하고, 좌측 입력 묶음에서 중앙 판단 레이어를 거쳐 우측 실행 결과로 이어지는 비대칭 레이아웃을 사용한다.
...
## Filename And Paths
- filename: accounts-receivable-tracker-hero.png
- rawPath: assets/images/raw/accounts-receivable-tracker-hero.png
- optimizedPath: public/images/posts/accounts-receivable-tracker-1200.webp

## Alt Text
거래처별 미수금, 청구일, 약속일, 후속 조치 상태가 한눈에 정렬된 영업 운영 보드형 대표 이미지를 설명하는 영업 운영 이미지

## Caption
거래처별 미수금, 청구일, 약속일, 후속 조치 상태가 한눈에 정렬된 영업 운영 보드형 대표 이미지를 안전한 로컬 이미지 제작용 브리프로 정리합니다.
...
```json
{
  ...
  "rawPath": "assets/images/raw/accounts-receivable-tracker-hero.png",
  "altKo": "거래처별 미수금, 청구일, 약속일, 후속 조치 상태가 한눈에 정렬된 영업 운영 보드형 대표 이미지를 설명하는 영업 운영 이미지",
  "captionKo": "거래처별 미수금, 청구일, 약속일, 후속 조치 상태가 한눈에 정렬된 영업 운영 보드형 대표 이미지를 안전한 로컬 이미지 제작용 브리프로 정리합니다.",
  "width": 1200,
  "height": 675,
  "format": "webp",
...
## Article Update Plan
- 실제 이미지 승인 후 frontmatter heroImage 후보: /images/posts/accounts-receivable-tracker-1200.webp
- 실제 이미지 승인 후 frontmatter heroAlt 후보: 거래처별 미수금, 청구일, 약속일, 후속 조치 상태가 한눈에 정렬된 영업 운영 보드형 대표 이미지를 설명하는 영업 운영 이미지
...
- Save the raw image to assets/images/raw/accounts-receivable-tracker-hero.png.
- Optimize to public/images/posts/accounts-receivable-tracker-1200.webp only after manual review.
