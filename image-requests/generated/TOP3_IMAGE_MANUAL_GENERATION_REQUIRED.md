# TOP3 Premium Image Manual Generation Required

Status: `BLOCKED_RAW_IMAGES_MISSING`
Date: 2026-06-16
Source:

- `image-requests/generated/PREMIUM_IMAGE_HANDOFF_TOP3.md`
- `image-requests/generated/TOP3_IMAGE_COPY_PROMPTS.md`

Codex cannot apply or optimize images until these raw files exist. Do not use deterministic fallback for final premium visuals.
...
## Shared Manual Generation Rules

- Create a premium SaaS/editorial hero image, 16:9, target 1200 x 675.
- Save only local raw PNG files to the exact `assets/images/raw/...` paths above.
- Do not use external URLs, scraped images, hotlinks, Amazon/product imagery, or public uploads.
- Do not use deterministic SVG fallback as final premium artwork.
- Avoid real logos, people/faces, private data, fake sensitive dashboards, readable customer names, phone numbers, payment data, or contract identifiers.
- Keep in-image text minimal and abstract.
