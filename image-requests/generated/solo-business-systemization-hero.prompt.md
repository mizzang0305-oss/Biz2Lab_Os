...
## Article Context
- articleTitle: 1인 사업자가 업무를 시스템화하는 방법
- categoryStyle: 소상공인 운영: 주문, 예약, 고객 메모, 리뷰 대응이 한 화면에서 정리되는 친근하지만 전문적인 매장 운영 워크플로
- visualDifferentiationHint: 고객 메모를 중심 모티프로 사용하고, 중앙에는 핵심 업무 흐름을 두고 우측에는 결과 상태 패널을 배치한다.
...
## Filename And Paths
- filename: solo-business-systemization-hero.png
- rawPath: assets/images/raw/solo-business-systemization-hero.png
- optimizedPath: public/images/posts/solo-business-systemization-1200.webp

## Alt Text
1인 사업자의 주문, 상담, 정산, 고객 기록이 놓치지 않는 운영 시스템으로 정리되는 대표 이미지를 설명하는 소상공인 운영 이미지

## Caption
1인 사업자의 주문, 상담, 정산, 고객 기록이 놓치지 않는 운영 시스템으로 정리되는 대표 이미지를 안전한 로컬 이미지 제작용 브리프로 정리합니다.

## Manifest Draft
```json
{
  "id": "solo-business-systemization-hero",
  "project": "biz2lab",
  "postSlug": "solo-business-systemization",
  "usage": "hero",
  "src": "/images/posts/solo-business-systemization-1200.webp",
  "rawPath": "assets/images/raw/solo-business-systemization-hero.png",
  "altKo": "1인 사업자의 주문, 상담, 정산, 고객 기록이 놓치지 않는 운영 시스템으로 정리되는 대표 이미지를 설명하는 소상공인 운영 이미지",
  "captionKo": "1인 사업자의 주문, 상담, 정산, 고객 기록이 놓치지 않는 운영 시스템으로 정리되는 대표 이미지를 안전한 로컬 이미지 제작용 브리프로 정리합니다.",
  "width": 1200,
  "height": 675,
  "format": "webp",
...
## Article Update Plan
- 실제 이미지 승인 후 frontmatter heroImage 후보: /images/posts/solo-business-systemization-1200.webp
- 실제 이미지 승인 후 frontmatter heroAlt 후보: 1인 사업자의 주문, 상담, 정산, 고객 기록이 놓치지 않는 운영 시스템으로 정리되는 대표 이미지를 설명하는 소상공인 운영 이미지
...
- Save the raw image to assets/images/raw/solo-business-systemization-hero.png.
- Optimize to public/images/posts/solo-business-systemization-1200.webp only after manual review.
