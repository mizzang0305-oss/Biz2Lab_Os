...
export const trustPages: readonly HealthTrustPage[] = [
  ...
  },
  {
    slug: "terms",
    title: "이용약관",
    seoTitle: "오누림 이용약관: 개인 이용 범위와 자료 변경 안내",
    description: "오누림 페이지와 개인용 기록표의 이용 범위, 의료적 한계, 자료 수정 원칙을 안내합니다. 개인정보·정정 정책에서 기록 보관과 문의 경로의 현재 상태도 확인하세요.",
    updatedAt: "2026-09-07",
    indexDecision: "NOINDEX_FOLLOW",
    intro: "오누림 자료는 개인의 일반 건강교육과 진료 질문 준비를 위한 정보입니다.",
    sections: [
      { title: "개인 이용 범위", body: "페이지를 읽고 개인용 기록표를 출력할 수 있습니다. 출처를 지우거나 오누림의 의료 권고처럼 재판매할 수 없습니다. 출력물과 기기에 보관한 사본을 다룰 때의 주의사항은 개인정보 안내를 함께 확인하세요.", links: [{ href: "/health/trust/privacy", label: "기록표·출력물과 개인정보 안내" }] },
      { title: "의료적 한계", body: "콘텐츠와 도구는 의료기관의 진단·치료·응급 판단을 대체하지 않습니다. 자료의 이용 범위와 위급한 상황의 도움 요청 안내는 면책 안내에서 설명합니다.", links: [{ href: "/health/trust/disclaimer", label: "건강정보와 개인 의료 판단의 경계" }] },
      { title: "자료의 변경과 정정", body: "출처 갱신, 안전성 보완 또는 서비스 운영상 필요에 따라 내용을 수정할 수 있으며 중요한 정정은 기록합니다. 정정 경로와 현재 접수 확인 상태는 정정 정책에서 확인하세요.", links: [{ href: "/health/trust/corrections-policy", label: "정정 원칙과 접수 경로 확인" }] },
    ],
  },
  {
    slug: "contact",
