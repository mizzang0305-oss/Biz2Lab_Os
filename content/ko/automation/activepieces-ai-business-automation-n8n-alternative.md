...
"어떤 업무 흐름을 맡길 것인가"와 "어디까지 내 데이터와 운영 범위를 통제할 것인가"입니다. "완전한 무료 오픈소스 도구"라고 단정하면 위험합니다. 공식 GitHub와 라이선스 문서를 보면 core는 MIT로 공개되어 있지만, enterprise와 cloud 기능은 상업용 라이선스가 함께 존재하는 open-core 구조로 이해하는 편이 안전합니다. 상업적 운영 전에는 반드시 공식 LICENSE와 가격 정책을 다시 확인해야 합니다.
