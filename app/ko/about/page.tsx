    ...
    <main className="mx-auto max-w-4xl px-4 py-12 sm:px-5 sm:py-14">
      <header>
        ...
        <div className="mt-6 grid gap-5 text-lg leading-8 text-slate-600">
          <p>
            Biz2Lab은 식자재 유통과 B2B 영업 현장에서 반복된 주문 누락, 입금 약속,
            계약 미작성, 재고 차이와 검수 누락을 시스템으로 옮긴 과정을 기록합니다.
          </p>
          <p>
            운영 화면과 상태 모델을 직접 만든 이유, 로컬 fixture로 다시 확인한 범위,
            실패했을 때 멈추고 복구하는 기준을 함께 설명합니다.
          </p>
        </div>
      </header>
      ...
      <section className="mt-10 rounded-xl border border-teal-200 bg-teal-50 p-6">
        ...
        <ul className="mt-5 grid gap-3 leading-7 text-slate-700">
          ...
          <li>전화·메시지·포털 주문의 원본과 보류 사유를 분리하는 주문 작업대</li>
          <li>피킹·검수·상차와 재고 차이를 별도 상태로 유지하는 식자재 유통 WMS</li>
          <li>본인확인·서명·계약 문서의 민감정보 경계를 설계한 전자계약 시스템</li>
