...
export default function CommercialPrivacyPage() {
  return (
    <CommercialShell><article className="mx-auto max-w-3xl px-4 py-14 text-slate-800 sm:px-6">
      ...
      <p className="mt-3 leading-7">정보는 선택 서비스의 문의 답변 또는 별도로 동의한 후속 안내에만 사용하도록 설계했습니다. 건강정보·결제정보·고객 명단을 이 폼으로 받지 않습니다. 현재 저장·운영자 조회·보관 및 삭제 절차의 Production 검증이 끝나지 않아 접수 기능은 기본 비활성입니다. 저장 확인에 실패하면 접수 완료로 표시하지 않습니다.</p>
