...
## Tool 21 부모 연결 재확인 — 2026-09-06

도구 카드 제목·소개를 검사 중심으로 바꾸고 ‘한 장’ 약속을 제거했다. 본문 의료 설명·claim은 변경하지 않았다. 부모 route의 360/390/430/768/1440 QA와 SEO 재실행 fail0. raw/page-qa/dyslipidemia.json는 이 재검사 시각·관찰값이다. 아래 초기 전체 suite/build 결과는 당시 증거이며 Tool21 이후 새 전체 build로 오인하지 않는다.
