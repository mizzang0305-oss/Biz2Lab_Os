...
export function CommercialForms({ service }: { service: CommercialService }) {
  ...
  return (
    <section id="inquiry" className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
      ...
      <p className="mt-3 max-w-3xl text-slate-600">제공 가능 범위와 공개 시점을 먼저 확인합니다. 고객 명단·건강 기록·결제 정보, 비밀번호·API key·access token·refresh token·private key·credential file은 입력하지 마세요.</p>
